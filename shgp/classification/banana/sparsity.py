...
which is afforded to us by the use of greedy variance / heteroscedastic greedy variance.

This is a very small-scale problem and so the benefits are less visible. For a more concrete analysis,
see results for the magic dataset.
